            ...
            <div className='center'>
                <div className='black-card'>
                    ...
                    <div className='black-card-content'>
                        ...
                        <a href='${process.env.NODE_ENV === 'production' ? process.env.PUBLIC_URL : process.env.CLIENT_URL}/activate/${token}'>Setup keyPass</a>
            ...
            <div className='center'>
                <div className='black-card'>
                    ...
                    <div className='black-card-content'>
                        ...
                        <a href='${process.env.NODE_ENV === 'production' ? process.env.PUBLIC_URL : process.env.CLIENT_URL}/activate/${token}'>Setup EditKey</a>
                        <small>Password Collector</small>
                    </div>
                </div>
            </div>
            ...
            <div className='center'>
                <div className='black-card'>
                    ...
                    <div className='black-card-content'>
                        ...
                        <a href='${process.env.NODE_ENV === 'production' ? process.env.PUBLIC_URL : process.env.CLIENT_URL}/reset/${token}'>Reset Password</a>
                        <small>Password Collector</small>
                    </div>
                </div>
            </div>
            ...
            <div className='center'>
                <div className='black-card'>
                    ...
                    <div className='black-card-content'>
                        ...
                        <a href='${process.env.NODE_ENV === 'production' ? process.env.PUBLIC_URL : process.env.CLIENT_URL}/recover/${token}'>Recover editKey</a>
                        <small>Password Collector</small>
                    </div>
                </div>
            </div>
